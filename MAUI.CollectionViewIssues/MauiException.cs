...
//    public static event UnhandledExceptionEventHandler UnhandledException = new UnhandledExceptionEventHandler(MyHandler);
...
//            HttpRequestMessage rm = new HttpRequestMessage(HttpMethod.Post, GlobalConstants.API_BASE_URL + "/api/error")
//            {
...
//            var res = _httpClient.SendAsync(rm);
//        }
//        catch (Exception)
//        {
//        }
